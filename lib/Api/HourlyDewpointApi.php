...
/**
 * HourlyDewpointApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class HourlyDewpointApi
{
    ...
    /**
     * Operation hourlyDewpointByAsset
     *
     ...
     */
    public function hourlyDewpointByAsset($asset_uuid, $start = null, $end = null, $unit = null)
    {
        list($response) = $this->hourlyDewpointByAssetWithHttpInfo($asset_uuid, $start, $end, $unit);
        return $response;
    }

    /**
     * Operation hourlyDewpointByAssetWithHttpInfo
     *
     * Hourly Dewpoint by asset
     *
     * @param double $asset_uuid Unique asset id. (required)
     ...
     */
    public function hourlyDewpointByAssetWithHttpInfo($asset_uuid, $start = null, $end = null, $unit = null)
    {
        // verify the required parameter 'asset_uuid' is set
        if ($asset_uuid === null) {
            throw new \InvalidArgumentException('Missing the required parameter $asset_uuid when calling hourlyDewpointByAsset');
        }
        // parse inputs
        $resourcePath = "/hourly-dewpoint/{asset-uuid}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
...
>>>>>>> b4b592f0f75f5d6ba0501be7b1212d3e9f9102d2
    ...
    /**
     * Operation hourlyDewpointByLocation
     *
     ...
     */
    public function hourlyDewpointByLocation($latitude, $longitude, $start = null, $end = null, $unit = null)
    {
        list($response) = $this->hourlyDewpointByLocationWithHttpInfo($latitude, $longitude, $start, $end, $unit);
        return $response;
    }

    /**
     * Operation hourlyDewpointByLocationWithHttpInfo
     *
     * Hourly Dewpoint by location
     *
     * @param double $latitude  (required)
     ...
     */
    public function hourlyDewpointByLocationWithHttpInfo($latitude, $longitude, $start = null, $end = null, $unit = null)
    {
        // verify the required parameter 'latitude' is set
        if ($latitude === null) {
            throw new \InvalidArgumentException('Missing the required parameter $latitude when calling hourlyDewpointByLocation');
        }
        // verify the required parameter 'longitude' is set
        if ($longitude === null) {
            throw new \InvalidArgumentException('Missing the required parameter $longitude when calling hourlyDewpointByLocation');
        }
        // parse inputs
        $resourcePath = "/hourly-dewpoint/{latitude}/{longitude}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
...
>>>>>>> b4b592f0f75f5d6ba0501be7b1212d3e9f9102d2
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/hourly-dewpoint/{latitude}/{longitude}'
            );
    ...
    /**
     * Operation hourlyDewpointContoursByAsset
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\HourlyDewpointContoursByAssetData
     */
    public function hourlyDewpointContoursByAsset($asset_uuid, $unit = null, $valid_time = null)
    {
        list($response) = $this->hourlyDewpointContoursByAssetWithHttpInfo($asset_uuid, $unit, $valid_time);
        return $response;
    }

    /**
     * Operation hourlyDewpointContoursByAssetWithHttpInfo
     *
     * Hourly Dewpoint contours by asset
     *
     * @param double $asset_uuid Unique asset id. (required)
     ...
     * @param \DateTime $valid_time Valid time. June 01, 2016 to 7 days in the future. (YYYY-MM-DDTHH:MM:SSZ) (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\HourlyDewpointContoursByAssetData, HTTP status code, HTTP response headers (array of strings)
     */
    public function hourlyDewpointContoursByAssetWithHttpInfo($asset_uuid, $unit = null, $valid_time = null)
    {
        // verify the required parameter 'asset_uuid' is set
        if ($asset_uuid === null) {
            throw new \InvalidArgumentException('Missing the required parameter $asset_uuid when calling hourlyDewpointContoursByAsset');
        }
        // parse inputs
        $resourcePath = "/hourly-dewpoint/{asset-uuid}/contours";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
...
>>>>>>> b4b592f0f75f5d6ba0501be7b1212d3e9f9102d2
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\HourlyDewpointContoursByAssetData',
                '/hourly-dewpoint/{asset-uuid}/contours'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\HourlyDewpointContoursByAssetData', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\HourlyDewpointContoursByAssetData', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Error', $e->getResponseHeaders());
