...
/**
 * HourlyTemperatureApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class HourlyTemperatureApi
{
    ...
    /**
     * Operation hourlyTemperatureByAsset
     *
     ...
     */
    public function hourlyTemperatureByAsset($asset_uuid, $start = null, $end = null, $unit = null)
    {
        list($response) = $this->hourlyTemperatureByAssetWithHttpInfo($asset_uuid, $start, $end, $unit);
        return $response;
    }

    /**
     * Operation hourlyTemperatureByAssetWithHttpInfo
     *
     * Hourly Temperature by asset
     *
     * @param double $asset_uuid Unique asset id. (required)
     ...
     */
    public function hourlyTemperatureByAssetWithHttpInfo($asset_uuid, $start = null, $end = null, $unit = null)
    {
        // verify the required parameter 'asset_uuid' is set
        if ($asset_uuid === null) {
            throw new \InvalidArgumentException('Missing the required parameter $asset_uuid when calling hourlyTemperatureByAsset');
        }
        // parse inputs
        $resourcePath = "/hourly-temperature/{asset-uuid}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
    ...
    /**
     * Operation hourlyTemperatureByLocation
     *
     ...
     * @param \DateTime $end End time (inclusive). Start of 2015 to 7 days in the future. (YYYY-MM-DDTHH:MM:SSZ) (optional)
     * @param string $unit temperature unit (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\HourlyProductByLocationData
     */
    public function hourlyTemperatureByLocation($latitude, $longitude, $start = null, $end = null, $unit = null)
    {
        list($response) = $this->hourlyTemperatureByLocationWithHttpInfo($latitude, $longitude, $start, $end, $unit);
        return $response;
    }

    /**
     * Operation hourlyTemperatureByLocationWithHttpInfo
     *
     * Hourly Temperature by location
     *
     * @param double $latitude  (required)
     ...
     */
    public function hourlyTemperatureByLocationWithHttpInfo($latitude, $longitude, $start = null, $end = null, $unit = null)
    {
        // verify the required parameter 'latitude' is set
        if ($latitude === null) {
            throw new \InvalidArgumentException('Missing the required parameter $latitude when calling hourlyTemperatureByLocation');
        }
        // verify the required parameter 'longitude' is set
        if ($longitude === null) {
            throw new \InvalidArgumentException('Missing the required parameter $longitude when calling hourlyTemperatureByLocation');
        }
        // parse inputs
        $resourcePath = "/hourly-temperature/{latitude}/{longitude}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/hourly-temperature/{latitude}/{longitude}'
            );
    ...
    /**
     * Operation hourlyTemperatureContoursByAsset
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\HourlyTemperatureContoursByAssetData
     */
    public function hourlyTemperatureContoursByAsset($asset_uuid, $unit = null, $valid_time = null)
    {
        list($response) = $this->hourlyTemperatureContoursByAssetWithHttpInfo($asset_uuid, $unit, $valid_time);
        return $response;
    }

    /**
     * Operation hourlyTemperatureContoursByAssetWithHttpInfo
     *
     * Hourly Temperature contours by asset
     *
     * @param double $asset_uuid Unique asset id. (required)
     ...
     * @param \DateTime $valid_time Valid time. June 01, 2016 to 7 days in the future. (YYYY-MM-DDTHH:MM:SSZ) (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\HourlyTemperatureContoursByAssetData, HTTP status code, HTTP response headers (array of strings)
     */
    public function hourlyTemperatureContoursByAssetWithHttpInfo($asset_uuid, $unit = null, $valid_time = null)
    {
        // verify the required parameter 'asset_uuid' is set
        if ($asset_uuid === null) {
            throw new \InvalidArgumentException('Missing the required parameter $asset_uuid when calling hourlyTemperatureContoursByAsset');
        }
        // parse inputs
        $resourcePath = "/hourly-temperature/{asset-uuid}/contours";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\HourlyTemperatureContoursByAssetData',
                '/hourly-temperature/{asset-uuid}/contours'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\HourlyTemperatureContoursByAssetData', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\HourlyTemperatureContoursByAssetData', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                default:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\Error', $e->getResponseHeaders());
