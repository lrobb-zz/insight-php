...
/**
 * GrowingDegreeDaysApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class GrowingDegreeDaysApi
{
    ...
    /**
     * Operation growingDegreeDaysByAsset
     *
     ...
     */
    public function growingDegreeDaysByAsset($asset_uuid, $base = null, $unit = null, $start = null, $end = null)
    {
        list($response) = $this->growingDegreeDaysByAssetWithHttpInfo($asset_uuid, $base, $unit, $start, $end);
        return $response;
    }

    /**
     * Operation growingDegreeDaysByAssetWithHttpInfo
     *
     * Growing degree days by asset
     *
     * @param double $asset_uuid Unique asset id. (required)
     ...
     */
    public function growingDegreeDaysByAssetWithHttpInfo($asset_uuid, $base = null, $unit = null, $start = null, $end = null)
    {
        // verify the required parameter 'asset_uuid' is set
        if ($asset_uuid === null) {
            throw new \InvalidArgumentException('Missing the required parameter $asset_uuid when calling growingDegreeDaysByAsset');
        }
        // parse inputs
        $resourcePath = "/growing-degree-days/{asset-uuid}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/growing-degree-days/{asset-uuid}'
            );
    ...
    /**
     * Operation growingDegreeDaysByLocation
     *
     ...
     */
    public function growingDegreeDaysByLocation($latitude, $longitude, $base = null, $unit = null, $start = null, $end = null)
    {
        list($response) = $this->growingDegreeDaysByLocationWithHttpInfo($latitude, $longitude, $base, $unit, $start, $end);
        return $response;
    }

    /**
     * Operation growingDegreeDaysByLocationWithHttpInfo
     *
     * Growing degree days by location
     *
     * @param double $latitude  (required)
     ...
     */
    public function growingDegreeDaysByLocationWithHttpInfo($latitude, $longitude, $base = null, $unit = null, $start = null, $end = null)
    {
        // verify the required parameter 'latitude' is set
        if ($latitude === null) {
            throw new \InvalidArgumentException('Missing the required parameter $latitude when calling growingDegreeDaysByLocation');
        }
        // verify the required parameter 'longitude' is set
        if ($longitude === null) {
            throw new \InvalidArgumentException('Missing the required parameter $longitude when calling growingDegreeDaysByLocation');
        }
        // parse inputs
        $resourcePath = "/growing-degree-days/{latitude}/{longitude}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/growing-degree-days/{latitude}/{longitude}'
            );
    ...
    /**
     * Operation growingDegreeDaysContoursByAsset
     *
     ...
     */
    public function growingDegreeDaysContoursByAsset($asset_uuid, $base = null, $unit = null, $start = null, $end = null)
    {
        list($response) = $this->growingDegreeDaysContoursByAssetWithHttpInfo($asset_uuid, $base, $unit, $start, $end);
        return $response;
    }

    /**
     * Operation growingDegreeDaysContoursByAssetWithHttpInfo
     *
     * Growing degree days contours by asset
     *
     * @param double $asset_uuid Unique asset id. (required)
     ...
     */
    public function growingDegreeDaysContoursByAssetWithHttpInfo($asset_uuid, $base = null, $unit = null, $start = null, $end = null)
    {
        // verify the required parameter 'asset_uuid' is set
        if ($asset_uuid === null) {
            throw new \InvalidArgumentException('Missing the required parameter $asset_uuid when calling growingDegreeDaysContoursByAsset');
        }
        // parse inputs
        $resourcePath = "/growing-degree-days/{asset-uuid}/contours";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/growing-degree-days/{asset-uuid}/contours'
            );
