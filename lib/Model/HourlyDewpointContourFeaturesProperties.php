...
/**
 * HourlyDewpointContourFeaturesProperties Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class HourlyDewpointContourFeaturesProperties implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HourlyDewpointContourFeatures_properties';
    ...
    {
        $this->container['dewpoint'] = isset($data['dewpoint']) ? $data['dewpoint'] : null;
    }
    ...
    {
        return $this->container['dewpoint'];
    }

    /**
     * Sets dewpoint
     * @param double $dewpoint
     * @return $this
     */
    public function setDewpoint($dewpoint)
    {
        $this->container['dewpoint'] = $dewpoint;
